...
#ifndef _OPENCOGSERVICES_PATTERNMINERSERVICE_H
#define _OPENCOGSERVICES_PATTERNMINERSERVICE_H
 ...
 *
 */
class PatternMinerService : public OpencogSNETService
{
...
#endif // _OPENCOGSERVICES_PATTERNMINERSERVICE_H
